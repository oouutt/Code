...
* @{
*/
#define PRODUCT_KEY "977c9d9b25744802987c350fed0c326d"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "11992347f54b4c5a99d6f3060dc24f66"
...
* @{
*/
#define mode_BYTEOFFSET                    0
#define mode_BITOFFSET                     0
#define mode_LEN                           1
#define toushi_BYTEOFFSET                    0
#define toushi_BITOFFSET                     1
#define toushi_LEN                           1
#define buchong_BYTEOFFSET                    2
#define buchong_BITOFFSET                     0
#define buchong_LEN                           1

#define shengyu_RATIO                         1
#define shengyu_ADDITION                      0
#define shengyu_MIN                           0
#define shengyu_MAX                           100
/**@} */
...
typedef enum
{
    buchong_VALUE0 = 0,//剩余食物充足
    buchong_VALUE1 = 1,//食物不足请补充
    buchong_VALUE_MAX,
} buchong_ENUM_T;
...
typedef struct {
  uint32_t valuemode;
  uint32_t valuetoushi;
  uint32_t valueshengyu;
  uint32_t valuebuchong;
} dataPoint_t;
...
typedef struct {
  uint8_t flagmode:1;
  uint8_t flagtoushi:1;
  uint8_t flagshengyu:1;
} attrFlags_t;
