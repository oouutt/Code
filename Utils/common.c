...
* @return sum : Checksum
*/
int32_t ICACHE_FLASH_ATTR returnWeekDay(uint32_t iYear, uint32_t iMonth, uint32_t iDay)
{
    int32_t iWeek = 0;
    uint32_t y = 0, c = 0, m = 0, d = 0;
...
static int32_t ICACHE_FLASH_ATTR isleap(int32_t year)
{
...
gizTime_t ICACHE_FLASH_ATTR returnNtp2Wt(uint32_t ntp)
{
    gizTime_t tm;
    int32_t x;
    int32_t i=1970, mons[] = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31 };
    uint32_t utc = ntp;
...
*/
void ICACHE_FLASH_ATTR str2Hex(char *pbDest, char *pbSrc, int32_t nLen)
{
    char h1,h2;
    char s1,s2;
    int32_t i;
...
*/
void ICACHE_FLASH_ATTR hex2Str(unsigned char *pbDest, unsigned char *pbSrc, int32_t nLen)
{
    char	ddl,ddh;
    int32_t i;
